...
<div class="wrap">
    ...
    <?php if ($verbunden) : ?>
        <?php $barrierepruefung_reiter = 'pruefung'; include BARRIEREPRUEFUNG_PATH.'views/reiter.php'; ?>
    <?php endif; ?>
    ...
    <?php else : ?>
        ...
        <p>
            <?php esc_html_e('When you prepare or publish the statement from the tab “Accessibility statement”, your answers and details are sent as well, together with your display name. The service records it as evidence of who released a version.', 'barrierepruefung-de-web-accessibility-checker'); ?>
        </p>
    <?php endif; ?>
</div>
