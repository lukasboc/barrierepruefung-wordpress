 ...
 * Description:       Scans this site for accessibility barriers, prepares and publishes your accessibility statement and embeds it via shortcode.
 * Version:           0.7.1
...
define('BARRIEREPRUEFUNG_VERSION', '0.7.1');
...
require_once BARRIEREPRUEFUNG_PATH.'includes/class-barrierepruefung-erklaerung.php';
...
add_action('plugins_loaded', static function (): void {
    ...
    if (is_admin()) {
        ...
        (new Barrierepruefung_Erklaerung)->register();
    }
});
